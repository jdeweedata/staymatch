...
const socialLinks = [
  {
    label: "Twitter",
    href: "https://twitter.com/staymatch",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/staymatch",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/staymatch",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className="py-12 border-t border-border">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div className="mt-8 pt-8 border-t border-border/50 text-center text-sm text-text-tertiary">
          <p>&copy; {new Date().getFullYear()} StayMatch. All rights reserved.</p>
          <p className="mt-1">Stop searching. Start matching.</p>
        </div>
      </div>
    </footer>
  );
